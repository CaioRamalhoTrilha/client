...
useHead({
  script: [{crossorigin:'anonymous', src:'https://kit.fontawesome.com/84b3553096.js' }]
});
onMounted(() => {
...
<div class="flex gap-2 py-6 px-36">
    <div class="grid grid-cols-2 gap-2">
      ...
      <div class="px-5 border-slate-300 border rounded-md w-5/12">
        <div class="flex mt-7 items-end">
          ...
          <div class="basis-3/4">
            <div class="flex justify-start">
              <h4 class="text-3xl font-semibold">Transparência</h4>
            </div>
          </div>
        </div>
        ...
        <div class="flex gap-4 mt-24">
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repellendus consectetur ratione quisquam veniam, amet harum corporis placeat tempore, aliquam culpa molestiae laboriosam, impedit fugit natus dolores iusto. Dicta, reiciendis totam.
          </p>
        </div>
      </div>
    </div>
...
.bg-img{
    // background-color: rgba(35, 27, 46, 1);
    height: 1440px;
    width: 1920px;
}
</style>